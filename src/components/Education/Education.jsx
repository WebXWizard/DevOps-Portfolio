...
const Education = () => {
  return (
    <section
      id="education"
      className="py-12 md:py-24 px-4 md:px-[7vw] lg:px-[16vw] font-sans bg-skills-gradient clip-path-custom-3"
    >
      {/* Section Title */}
      <div className="text-center mb-8 md:mb-16">
        ...
        <p className="text-gray-400 mt-3 md:mt-4 text-base md:text-lg font-semibold px-4">
          My academic journey through various institutions and learning experiences
        </p>
      </div>
        ...
        {education.map((edu, index) => (
          ...
          >
            ...
            >
              ...
              <p className="mt-4 text-sm md:text-base text-gray-400 font-bold">
                Grade: {edu.grade}
              </p>
              ...
              {edu.skills && (
                <div className="mt-4">
                  <h5 className="font-medium text-white text-sm md:text-base">Key Subjects:</h5>
